...
**TABLE 1** Covariate models for the July--September (*S~t~*) and
...
|                                  | > justification**                |
+----------------------------------+----------------------------------+
| Jun--Jul and Apr-Mar ocean       | > Precipitation over the ocean   |
| precipitation                    | > may directly or indirectly     |
|                                  | > prompt spawning, after which   |
| AF: *S~t~*                       | > spent adults migrate inshore   |
|                                  | > and are exposed to the         |
|                                  | > nearshore fishery.             |
+----------------------------------+----------------------------------+
| Jun--Jul land precipitation      | > Summer monsoon precipitation   |
|                                  | > over land leads to high        |
| AF: *S~t~*                       | > nutrient input from river      |
|                                  | > discharge. At high levels,     |
| GS: *W~t~, W~t+1~, S~t+1~*       | > this leads to eutrophication   |
|                                  | > and anoxia, which drives       |
|                                  | > adults off-shore away from the |
|                                  | > fishery. At moderate levels,   |
|                                  | > this supports nearshore        |
|                                  | > productivity.                  |
+----------------------------------+----------------------------------+
| Apr--Mar ocean precipitation     | > Spring precipitation is an     |
|                                  | > indicator of climatic          |
| SS: *W~t~, W~t+1~, S~t+1~*       | > conditions during egg          |
|                                  | > development, which aﬀect       |
|                                  | > spawning success and thus the  |
|                                  | > cohort strength.               |
+----------------------------------+----------------------------------+
| Jun--Sep upwelling               | > Upwelling drives phytoplankton |
|                                  | > blooms which bring fish closer |
| AF: *S~t~*                       | > to the coast (and the fishery) |
|                                  | > and which promote larval and   |
| GS+AF: *W~t~*                    | > juvenile growth and survival.  |
|                                  | > However extreme upwelling      |
| GS: *W~t~, W~t+1~, S~t+1~*       | > advects phytoplankton biomass  |
|                                  | > offshore and brings hypoxic    |
|                                  | > water to the surface.          |
+----------------------------------+----------------------------------+
| Mar--May r-SST                   | > Extreme pre-monsoon heating    |
|                                  | > events drive mature fish from  |
| AF: *S~t~*                       | > spawning areas, resulting in   |
|                                  | > poor recruitment and fewer     |
| *SS: W~t~, W~t+1~, S~t+1~*       | > 0-year fish.                   |
+----------------------------------+----------------------------------+
| Oct--Dec ns-SST                  | > October-December are the peak  |
|                                  | > somatic growth months, and     |
| GS: *W~t~, W~t+1~, S~t+1~*       | > larval and juvenile growth and |
|                                  | > survival are aﬀected by        |
|                                  | > temperature in the nearshore   |
|                                  | > feeding area.                  |
+----------------------------------+----------------------------------+
| Jul-Sep and Oct-Dec CHL          | > Surface chlorophyll-a          |
|                                  | > concentration is a proxy for   |
| AF: *S~t~*                       | > phytoplankton abundance. Peak  |
|                                  | > chlorophyll-a concentration is |
| GS+AF: *W~t~*                    | > in July-September while        |
|                                  | > October-December are critical  |
| GS: *W~t+1~, S~t+1~*             | > months for juvenile growth and |
|                                  | > survival.                      |
+----------------------------------+----------------------------------+
| 2.5-year average r-SST           | > Spawning, early survival, and  |
|                                  | > recruitment depend on many     |
| IA: *S~t~, W~t~, W~t+1~, S~t+1~* | > cascading factors summarized   |
|                                  | > by the average regional SST    |
|                                  | > over the lifespan of an oil    |
|                                  | > sardine.                       |
+----------------------------------+----------------------------------+
| ONI, PDO, AMO                    | > The large-scale ocean climate  |
|                                  | > has impacts on precipitation,  |
| IA: *S~t~, W~t~, W~t+1~, S~t+1~* | > SST, wind, currents and        |
|                                  | > upwelling patterns in the      |
|                                  | > south-western Indian Ocean.    |
|                                  | > These in turn have cascading   |
|                                  | > impacts on spawning, early     |
|                                  | > survival and abundance.        |
+----------------------------------+----------------------------------+
| Sep-Nov DMI                      | > Negative DMI values in         |
|                                  | > September--November are        |
| GS+AF: *W~t~*                    | > associated with anoxic events  |
|                                  | > along the Kerala coast which   |
| GS: *W~t~, W~t+1~, S~t+1~*       | > drive fish offshore and reduce |
|                                  | > juvenile growth and survival.  |
+----------------------------------+----------------------------------+
| *Notes.* Model codes: AF,        |                                  |
| availability to the nearshore    |                                  |
| fishery (movement inshore        |                                  |
| increases availability while     |                                  |
| movement offshore reduces        |                                  |
| availability); SS, spawning      |                                  |
| success; GS, growth and          |                                  |
| survival; IA, integrated         |                                  |
| abundance. Environmental         |                                  |
| covariates codes: r-SST,         |                                  |
| regional (0-160km) sea surface   |                                  |
| temperature; ns-SST, nearshore   |                                  |
| (0-80km) sea surface             |                                  |
| temperature; CHL, chlorophyll-a  |                                  |
| surface concentration; ONI,      |                                  |
| Oceanic Niño Index; DMI, Dipole  |                                  |
| Mode Index; PDO, Pacific Decadal |                                  |
| Oscillation index; AMO, Atlantic |                                  |
| Multidecadal Oscillation index.  |                                  |
+----------------------------------+----------------------------------+
|                                  |                                  |
+----------------------------------+----------------------------------+

**TABLE 2** Best-performing GAM models for the July--September ($S_{t})$
and October--March ($W_{t}$) catches. M is the base models with only
prior catch as covariates. To the base models, the environmental
covariates are added. Nearshore SST is 0-80km from the coast and
regional SST is 0-160km. The full set of nested covariate models with
all tested environmental variables are given in Tables A1, A2 and Table
S7.

  ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
  Model                                                                                                                      Res. df   Adj. R^2^   RMSE   AICc                     LOOCV                              LOOCV
                                                                                                                                                                                                                      
                                                                                                                                                                                   RMSE                               MdAE
  -------------------------------------------------------------------------------------------------------------------------- --------- ----------- ------ ------------------------ ---------------------------------- ----------------------------------
  **July-Sept catch 1983-2015**                                                                                                                                                                                        

  null model: $ln(S_{t}) = ln(S_{t - 1}) + \epsilon_{t}$                                                                     33                    1.60   126.6                    1.60                               0.56

  M0: $ln(S_{t}) = \alpha + s(ln(W_{t - 1})) + \epsilon_{t}$                                                                 30        21.7        1.20   115.2                    1.31                               0.69

  covariate model: $ln(S_{t})$ = M0 + $s(V)$                                                                                                                                                                          

  $V$ = Jun-Sep nearshore SST *t*                                                                                            27.4      32.5        1.07   115.2                    1.31                               0.62$\ddagger \ddagger$

  $V$ = Jun-Jul precipitation over land *t*                                                                                  28        29.9        1.10   115.3                    1.33                               0.62$\ddagger \ddagger$

  $V$ = 2.5-year ave. regional SST *t*                                                                                       28.1      47          0.96   105.7$\dagger \dagger$   1.38                               0.56$\ddagger \ddagger$

  $V$ = AMO ave. Jul-Jun *t*                                                                                                 27.5      47.5        0.94   106.6$\dagger \dagger$   1.22$\ddagger$                     0.56$\ddagger \ddagger$

                                                                                                                                                                                                                       

  **October-March catch - simpler model 1983-2014**                                                                                                                                                                   

  null model: $ln(W_{t}) = ln(W_{t - 1}) + \epsilon_{t}$                                                                     32                    1.00   92.9                     1.00                               0.26

  M1: $ln(W_{t}) = \alpha + s(ln(W_{t - 1})) + \epsilon_{t}$                                                                 29.1      45.9        0.82   87.7                     0.96                               0.32

  covariate model: $ln(W_{t})$ = M1 + $s(V)$                                                                                                                                                                          

  $V$ = Jun-Jul precipitation over land *t*                                                                                  26.9      59.6        0.69   82.1$\dagger \dagger$    0.91$\ddagger$                     0.25$\ddagger \ddagger \ddagger$

  $V$ = 2.5-year ave. regional SST *t*                                                                                       27.1      65.9        0.63   76.4$\dagger \dagger$    0.77$\ddagger \ddagger$            0.41

  $V$ = Sep-Nov DMI *t-1*                                                                                                    26        44.4        0.79   94.3                     0.95                               0.34

  $V$= AMO ave. Jul-Jun *t*                                                                                                  26.6      63.8        0.64   79.4$\dagger \dagger$    0.81$\ddagger \ddagger$            0.38

                                                                                                                                                                                                                       

  **October-March catch - more complex model 1983-2014**                                                                                                                                                              

  M2: $\ln\left( W_{t} \right) = \alpha + s\left( \ln\left( W_{t - 1} \right) \right) + \ s(ln(S_{t - 2})) + \epsilon_{t}$   26.6      57.3        0.70   84.6                     1.06                               0.34

  covariate model: $ln(W_{t})$ = M2 + $s(V)$                                                                                                                                                                          

  $V$ = Jun-Jul precipitation over land *t*                                                                                  24.6      70.5        0.56   77.5$\dagger \dagger$    0.96$\ddagger$                     0.29$\ddagger \ddagger$

  $\text{V\ }$= 2.5-year ave. regional SST *t*                                                                               24.8      69.5        0.57   78.1$\dagger \dagger$    0.82$\ddagger \ddagger \ddagger$   0.35

  $V$ = Sep-Nov DMI *t-1*                                                                                                    23.8      69.1        0.56   81.1$\dagger$            0.87$\ddagger \ddagger$            0.34

  $\text{V\ }$= AMO ave. Jul-Jun *t*                                                                                         24.3      65.6        0.60   83.1                     0.91$\ddagger \ddagger$            0.29$\ddagger \ddagger$

                                                                                                                                                                                                                       
  ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------

Notes: LOOCV = Leave one out cross-validation. RMSE = root mean square
error. MdAE = median absolute error. AICc = Akaike Information Criterion
corrected for small sample size. $\dagger$ and $\dagger \dagger$ = AICc
greater than 2 and greater than 5 below base catch model (M).
$\ddagger$, $\ddagger \ddagger$, and $\ddagger \ddagger \ddagger$ =
LOOCV RMSE and MdAE 5%, 10% and 20% below model M, respectively. $t$
indicates the covariate from the current year while t-1 indicates from
the prior year. For covariates that are multiyear, $t$ is the last
calendar year (i.e., the 2014 multiyear average regional SST is January
2012 to June 2014). The equations with s() are GAM models where the
covariates has a non-linear response (defined by a spline based
smoothing function). The full set of nested tests for the base catch
models (no environmental covariates) are given in the Supporting
